...
*   Return Value  : DRV_CanStatus_ten - Status of initialization
*  --------------------------------------------------------------------------- */
...
*   Return Value  : DRV_CanStatus_ten - Status of configuration
*  --------------------------------------------------------------------------- */
...
*   Return Value  : DRV_CanStatus_ten - Status of transmission
*  --------------------------------------------------------------------------- */
DRV_CanStatus_ten DRV_CAN_TransmitBlock_gen(DRV_CanInstance_ten instance_enarg,
                            U8 bufferIdx_argu8,
                            const DRV_CanFrame_tst* frameargst)
{
    const flexcan_data_info_t txInfo = {
    ...
    status_t status_En =FLEXCAN_DRV_SendBlocking(DRV_CanInstances_arrst[instance_enarg],
			bufferIdx_argu8, &txInfo, frameargst->DRV_CanId_u32,
			frameargst->DRV_Data_arru8, DRV_CAN_TIMEOUT);
...
*   Return Value  : DRV_CanStatus_ten - Status of receive operation
*  --------------------------------------------------------------------------- */
DRV_CanStatus_ten DRV_CAN_ReceiveBlock_gen(DRV_CanInstance_ten instance_enarg,
                           U8 bufferIdx_argu8,
                           DRV_CanFrame_tst* frame_argst)
{
    status_t status_En =FLEXCAN_DRV_ReceiveBlocking(DRV_CanInstances_arrst[instance_enarg], bufferIdx_argu8, &DRV_RecvBuff[bufferIdx_argu8],DRV_CAN_TIMEOUT);
...
*   Return Value  : DRV_CanStatus_ten - Status of deinitialization
*  --------------------------------------------------------------------------- */
...
*   Return Value  : DRV_CanStatus_ten - Status of filter configuration
*  --------------------------------------------------------------------------- */
